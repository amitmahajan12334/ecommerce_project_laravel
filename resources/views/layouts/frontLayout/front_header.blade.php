					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>+91 7376132434</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> amitmahajan@gmail.com </a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{ url('./')}}"><h3 style="color: black">Online Shop</h3></a>
						</div>
					</div>
					<div class="col-sm-8">
