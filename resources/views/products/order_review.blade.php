		...
		<div class="container">
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
									...
									<tr>
										...
										<td><span class="btn-secondary" data-toggle="tooltip" data-html="true" title="">₹ {{ $grand_total }}</span></td>
									</tr>
								</table>
							</td>
						</tr>
			...
			<form name="paymentForm" id="paymentForm" action="{{ url('/place-order') }}" method="post">{{ csrf_field() }}
				...
				<div class="payment-options">
					...
					<span>
						<label><input type="radio" name="payment_method" id="COD" value="COD"> <strong>Pay on Delivery(Cash/UPI/Card)</strong></label>
					</span>
					@endif
